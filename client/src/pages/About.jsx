      ...
      <div className="flex h-full  w-full flex-col items-center justify-center">
        <div className="">
          ...
          <p className="mt-1 text-[15px] lg:mt-3">
            Welcome to NHCE NotesHub, the ultimate hub for students to seamlessly
        ...
        <div className="">
          ...
          <p className="mt-1 text-[15px] lg:mt-3">
            NHCE NotesHub is more than just a website; it's a community-driven
        ...
        <div className="">
          ...
          <p className="mt-1 text-[15px] lg:mt-3">
            At NHCE NotesHub, our mission is clear: to empower students by
